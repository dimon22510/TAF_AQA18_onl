...
public class CSSSelectorsTest {
    ...
    public void cssLocatorsTest() throws InterruptedException {
        ...
        //Поиск по нескольким значениям в атрибуте класс(через точку)
        ...
        //Поиск элементов по classname с учётом иерархии
        Assert.assertEquals(driver.findElements(By.cssSelector("#Lastname .markup")).size(), 2);


        //Поиск всех элементов с tagName h1 or p
        ...
        // Поиск всех элементов у которых присутсвует аттрибут lang
